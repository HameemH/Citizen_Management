...
<body class="min-h-screen flex items-center justify-center">
    ...
    <div class="bg-[#e8ebff] p-8 pt-6 rounded-[30px] shadow-[8px_8px_16px_#c2c5d6,_-8px_-8px_16px_#ffffff] w-[360px] text-center">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <!-- Email Field -->
            <div class="flex items-center mb-5 px-4 py-3 rounded-full bg-[#e8ebff] shadow-[inset_5px_5px_10px_#c2c5d6,_inset_-5px_-5px_10px_#ffffff]">
...
<!-- Role Selector -->
<div class="mb-6 px-4 py-3 rounded-full bg-[#e8ebff] shadow-[inset_5px_5px_10px_#c2c5d6,_inset_-5px_-5px_10px_#ffffff] flex items-center">
    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-500 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        <path d="M20 6L9 17l-5-5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
    <select name="role" required class="w-full bg-transparent outline-none text-gray-700 text-sm appearance-none">
        ...
        <!-- Footer -->
        <p class="text-[11px] text-gray-500 mt-6">© 2025 Citizen Management Software</p>
    </div>
