...
<div class="space-y-6">
    <div class="bg-white shadow rounded-lg p-6 space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                @if(auth()->id() === $rentAgreement->tenant_id)
                    <p class="text-lg font-semibold text-gray-900">{{ $rentAgreement->landlord?->display_name }}</p>
                    <p class="text-sm text-gray-500">{{ $rentAgreement->landlord?->email }}</p>
                @else
    ...
    <a href="{{ route('citizen.rent-agreements.index') }}" class="inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-600 bg-white border border-gray-200 rounded shadow-sm hover:bg-gray-50">Back</a>
</div>
@endsection
