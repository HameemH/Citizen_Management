            ...
            <div class="flex flex-col flex-grow pt-5 overflow-y-auto bg-green-700">
                ...
                <nav class="mt-8 flex-1 px-2 space-y-1">
                    ...
                    <a href="{{ route('citizen.taxes.index') }}" 
                       class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('citizen.taxes.*') ? 'bg-green-800 text-white' : 'text-green-100 hover:bg-green-600' }}">
                        <svg class="mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
