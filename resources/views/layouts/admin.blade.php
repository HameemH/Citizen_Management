            ...
            <div class="flex flex-col flex-grow pt-5 overflow-y-auto bg-indigo-700">
                ...
                <nav class="mt-8 flex-1 px-2 space-y-1">
                    ...
                    <a href="{{ route('admin.verification.index') }}" 
                       class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.verification.*') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-600' }}">
                        <svg class="mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                       ...
                       class="group flex items-center justify-between px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.revenue.*') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-600' }}">
                        ...
                        @endif
                          ...
                          <a href="{{ route('admin.complaints.index') }}" 
                              class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.complaints.*') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-600' }}">
                        <svg class="mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a href="{{ route('admin.rent-agreements.index') }}" 
                       class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.rent-agreements.*') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-600' }}">
                        <svg class="mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
